...
func (_CurveGauge *CurveGaugeCaller) DOMAINSEPARATOR(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _CurveGauge.contract.Call(opts, &out, "DOMAIN_SEPARATOR")
...
//
// Solidity: function DOMAIN_SEPARATOR() view returns(bytes32)
func (_CurveGauge *CurveGaugeSession) DOMAINSEPARATOR() ([32]byte, error) {
	return _CurveGauge.Contract.DOMAINSEPARATOR(&_CurveGauge.CallOpts)
}

// DOMAINSEPARATOR is a free data retrieval call binding the contract method 0x3644e515.
//
// Solidity: function DOMAIN_SEPARATOR() view returns(bytes32)
func (_CurveGauge *CurveGaugeCallerSession) DOMAINSEPARATOR() ([32]byte, error) {
	return _CurveGauge.Contract.DOMAINSEPARATOR(&_CurveGauge.CallOpts)
}
...
func (_CurveGauge *CurveGaugeCaller) Factory(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _CurveGauge.contract.Call(opts, &out, "factory")
...
//
// Solidity: function factory() view returns(address)
func (_CurveGauge *CurveGaugeSession) Factory() (common.Address, error) {
	return _CurveGauge.Contract.Factory(&_CurveGauge.CallOpts)
}

// Factory is a free data retrieval call binding the contract method 0xc45a0155.
//
// Solidity: function factory() view returns(address)
func (_CurveGauge *CurveGaugeCallerSession) Factory() (common.Address, error) {
	return _CurveGauge.Contract.Factory(&_CurveGauge.CallOpts)
}
...
func (_CurveGauge *CurveGaugeCaller) Nonces(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _CurveGauge.contract.Call(opts, &out, "nonces", arg0)
...
//
// Solidity: function nonces(address arg0) view returns(uint256)
func (_CurveGauge *CurveGaugeSession) Nonces(arg0 common.Address) (*big.Int, error) {
	return _CurveGauge.Contract.Nonces(&_CurveGauge.CallOpts, arg0)
}

// Nonces is a free data retrieval call binding the contract method 0x7ecebe00.
//
// Solidity: function nonces(address arg0) view returns(uint256)
func (_CurveGauge *CurveGaugeCallerSession) Nonces(arg0 common.Address) (*big.Int, error) {
	return _CurveGauge.Contract.Nonces(&_CurveGauge.CallOpts, arg0)
}
...
//
// Solidity: function reward_data(address arg0) view returns((address,address,uint256,uint256,uint256,uint256))
func (_CurveGauge *CurveGaugeCaller) RewardData(opts *bind.CallOpts, arg0 common.Address) (Struct0, error) {
	var out []interface{}
...
//
// Solidity: function reward_data(address arg0) view returns((address,address,uint256,uint256,uint256,uint256))
func (_CurveGauge *CurveGaugeSession) RewardData(arg0 common.Address) (Struct0, error) {
...
//
// Solidity: function reward_data(address arg0) view returns((address,address,uint256,uint256,uint256,uint256))
func (_CurveGauge *CurveGaugeCallerSession) RewardData(arg0 common.Address) (Struct0, error) {
	return _CurveGauge.Contract.RewardData(&_CurveGauge.CallOpts, arg0)
}
...
func (_CurveGauge *CurveGaugeCaller) Salt(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _CurveGauge.contract.Call(opts, &out, "salt")
...
//
// Solidity: function salt() view returns(bytes32)
func (_CurveGauge *CurveGaugeSession) Salt() ([32]byte, error) {
	return _CurveGauge.Contract.Salt(&_CurveGauge.CallOpts)
}

// Salt is a free data retrieval call binding the contract method 0xbfa0b133.
//
// Solidity: function salt() view returns(bytes32)
func (_CurveGauge *CurveGaugeCallerSession) Salt() ([32]byte, error) {
	return _CurveGauge.Contract.Salt(&_CurveGauge.CallOpts)
}
...
func (_CurveGauge *CurveGaugeCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _CurveGauge.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() view returns(string)
func (_CurveGauge *CurveGaugeSession) Version() (string, error) {
	return _CurveGauge.Contract.Version(&_CurveGauge.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() view returns(string)
func (_CurveGauge *CurveGaugeCallerSession) Version() (string, error) {
	return _CurveGauge.Contract.Version(&_CurveGauge.CallOpts)
}
...
func (_CurveGauge *CurveGaugeTransactor) Permit(opts *bind.TransactOpts, _owner common.Address, _spender common.Address, _value *big.Int, _deadline *big.Int, _v uint8, _r [32]byte, _s [32]byte) (*types.Transaction, error) {
	return _CurveGauge.contract.Transact(opts, "permit", _owner, _spender, _value, _deadline, _v, _r, _s)
}

// Permit is a paid mutator transaction binding the contract method 0xd505accf.
//
// Solidity: function permit(address _owner, address _spender, uint256 _value, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) returns(bool)
func (_CurveGauge *CurveGaugeSession) Permit(_owner common.Address, _spender common.Address, _value *big.Int, _deadline *big.Int, _v uint8, _r [32]byte, _s [32]byte) (*types.Transaction, error) {
	return _CurveGauge.Contract.Permit(&_CurveGauge.TransactOpts, _owner, _spender, _value, _deadline, _v, _r, _s)
}

// Permit is a paid mutator transaction binding the contract method 0xd505accf.
//
// Solidity: function permit(address _owner, address _spender, uint256 _value, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) returns(bool)
func (_CurveGauge *CurveGaugeTransactorSession) Permit(_owner common.Address, _spender common.Address, _value *big.Int, _deadline *big.Int, _v uint8, _r [32]byte, _s [32]byte) (*types.Transaction, error) {
	return _CurveGauge.Contract.Permit(&_CurveGauge.TransactOpts, _owner, _spender, _value, _deadline, _v, _r, _s)
}
...
//
// Solidity: event UpdateLiquidityLimit(address indexed user, uint256 original_balance, uint256 original_supply, uint256 working_balance, uint256 working_supply)
func (_CurveGauge *CurveGaugeFilterer) FilterUpdateLiquidityLimit(opts *bind.FilterOpts, user []common.Address) (*CurveGaugeUpdateLiquidityLimitIterator, error) {
	...
	logs, sub, err := _CurveGauge.contract.FilterLogs(opts, "UpdateLiquidityLimit", userRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event UpdateLiquidityLimit(address indexed user, uint256 original_balance, uint256 original_supply, uint256 working_balance, uint256 working_supply)
func (_CurveGauge *CurveGaugeFilterer) WatchUpdateLiquidityLimit(opts *bind.WatchOpts, sink chan<- *CurveGaugeUpdateLiquidityLimit, user []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _CurveGauge.contract.WatchLogs(opts, "UpdateLiquidityLimit", userRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
