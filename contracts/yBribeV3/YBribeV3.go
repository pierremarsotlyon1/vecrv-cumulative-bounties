...
// GaugesPerReward is a free data retrieval call binding the contract method 0x32be6791.
//
// Solidity: function gauges_per_reward(address reward) view returns(address[])
func (_YBribeV3 *YBribeV3Caller) GaugesPerReward(opts *bind.CallOpts, reward common.Address) ([]common.Address, error) {
	var out []interface{}
...
//
// Solidity: function gauges_per_reward(address reward) view returns(address[])
func (_YBribeV3 *YBribeV3Session) GaugesPerReward(reward common.Address) ([]common.Address, error) {
	return _YBribeV3.Contract.GaugesPerReward(&_YBribeV3.CallOpts, reward)
}

// GaugesPerReward is a free data retrieval call binding the contract method 0x32be6791.
//
// Solidity: function gauges_per_reward(address reward) view returns(address[])
func (_YBribeV3 *YBribeV3CallerSession) GaugesPerReward(reward common.Address) ([]common.Address, error) {
	return _YBribeV3.Contract.GaugesPerReward(&_YBribeV3.CallOpts, reward)
}
